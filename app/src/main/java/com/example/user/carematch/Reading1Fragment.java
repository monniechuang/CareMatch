...
public class Reading1Fragment extends Fragment {
    private static final String TAG = "Reading1Fragment";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        PostListview = inflater.inflate(R.layout.reading1_fragment, container, false);
