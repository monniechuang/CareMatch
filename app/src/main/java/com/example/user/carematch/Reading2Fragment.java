...
public class Reading2Fragment extends Fragment {
    private static final String TAG = "Reading2Fragment";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        PostListview = inflater.inflate(R.layout.reading2_fragment, container, false);
        ...
        db.collection("Post")
                .orderBy("Post_thumbs", Query.Direction.DESCENDING)
                .limit(5)
