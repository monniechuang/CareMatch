...
public class Reading3SearchAdapter extends RecyclerView.Adapter<Reading3SearchAdapter.ViewHolder>{


    private static final String TAG = "TEST";
    public List<Post> SearchPageList;
    ...
    public Reading3SearchAdapter(Context applicationContext, List<Post> SearchPageList){
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        final String post_id =SearchPageList.get(position).postId;//抓ID ,List可以替換


        holder.postTitle.setText(SearchPageList.get(position).getPost_title());
        holder.postDesc.setText(SearchPageList.get(position).getPost_desc());
        holder.postDate.setText(SearchPageList.get(position).getPost_date());
        String Image=SearchPageList.get(position).getPost_image();
